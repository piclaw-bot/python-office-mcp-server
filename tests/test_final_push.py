...
class TestExcelExtendedMethods:
    ...
    def test_excel_extract_multi_sheet(self, temp_dir):
...
"""
    ...
    def test_excel_to_markdown(self, temp_dir):
...
class TestWordExtendedOps:
    ...
    def test_word_list_sections_with_subsections(self, temp_dir):
    ...
    def test_word_patch_section_append(self, temp_dir):
    ...
    def test_word_get_table_with_headers(self, temp_dir):
...
class TestPptxExtendedOps:
    ...
    def test_pptx_list_masters(self, temp_dir):
        ...
        result = tools.tool_pptx_list_masters(str(path))
        assert isinstance(result, dict)
        assert "default_layouts" in result

    def test_pptx_reorder_slides(self, temp_dir):
    ...
    def test_pptx_log_changes(self, temp_dir):
...
class TestWordComplexPatching:
    ...
    def test_replace_global_variables(self, temp_dir):
...
class TestPptxComplexOps:
    ...
    def test_pptx_add_table(self, temp_dir):
    ...
    def test_pptx_update_table_cell(self, temp_dir):
        ...
        result = tools.tool_pptx_patch_table_cell(
            str(path),
            slide_number=1,
            row_index=1,
            col_index=1,
    ...
    def test_pptx_patch_table_cell_string(self, temp_dir):
...
class TestWordTableOperations:
    ...
    def test_insert_table_row_at_end(self, temp_dir):
...
class TestPptxFromMarkdownVariations:
    ...
    def test_with_code_blocks(self, temp_dir):
...
"""
    ...
    def test_with_emphasis(self, temp_dir):
...
class TestWordFromMarkdownVariations:
    ...
    def test_with_links(self, temp_dir):
...
class TestPptxSlideManipulation:
    ...
    def test_delete_middle_slide(self, temp_dir):
        ...
        result = tools.tool_pptx_delete_slide(str(path), 2)
        assert isinstance(result, dict)

    def test_add_slide_at_start(self, temp_dir):
...
class TestWordAuditPaths:
    ...
    def test_audit_sow_with_placeholders(self, temp_dir):
...
class TestPptxBulletOperations:
    ...
    def test_add_multiple_bullets(self, temp_dir):
        ...
        # Add first bullet
        tools.tool_pptx_add_bullet(str(path), 1, "First point", level=0)

        # Add sub-bullet
        tools.tool_pptx_add_bullet(str(path), 1, "Sub-point", level=1)

        # Add another top-level
        result = tools.tool_pptx_add_bullet(str(path), 1, "Second point", level=0)
        assert isinstance(result, dict)

    def test_add_bullet_with_bold_label(self, temp_dir):
...
class TestSupportFunctions:
    ...
    def test_word_extract(self, temp_dir):
