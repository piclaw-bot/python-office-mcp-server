...
class TestWordPatchSectionEdgeCases:
    ...
    def test_patch_section_with_special_chars(self, word_advanced_tools, temp_dir):
...
class TestPptxBulletLevelVariations:
    ...
    def test_add_deeply_nested_bullet(self, pptx_advanced_tools, temp_dir):
        ...
        pptx_advanced_tools.tool_pptx_add_bullet(str(path), 1, "Level 0", level=0)
        pptx_advanced_tools.tool_pptx_add_bullet(str(path), 1, "Level 1", level=1)
        pptx_advanced_tools.tool_pptx_add_bullet(str(path), 1, "Level 2", level=2)
        result = pptx_advanced_tools.tool_pptx_add_bullet(str(path), 1, "Level 3", level=3)
...
class TestWordFixSplitPlaceholdersComplex:
    ...
    def test_fix_split_across_many_runs(self, word_advanced_tools, temp_dir):
...
class TestPptxHideUnhideOperations:
    ...
    def test_hide_then_unhide(self, pptx_advanced_tools, temp_dir):
        ...
        # Hide
        pptx_advanced_tools.tool_pptx_hide_slide(str(path), 1, hidden=True)
...
class TestWordCommentVariations:
    ...
    def test_add_comment_target_not_found(self, word_advanced_tools, temp_dir):
...
class TestWordDuplicateTableOperations:
    ...
    def test_duplicate_table_structure_with_styling(self, word_advanced_tools, temp_dir):
        ...
        result = word_advanced_tools.tool_word_duplicate_table_structure(str(path), "0")
        assert isinstance(result, dict)
...
class TestPptxSlideNumberEdgeCases:
    ...
    def test_slide_number_zero(self, pptx_advanced_tools, temp_dir):
        ...
        result = pptx_advanced_tools.tool_pptx_get_slide(str(path), 0)
        # Should return error or handle gracefully
        assert isinstance(result, dict)

    def test_negative_slide_number(self, pptx_advanced_tools, temp_dir):
...
class TestWordGetSectionVariations:
    ...
    def test_get_section_fuzzy_match(self, word_advanced_tools, temp_dir):
...
class TestPptxSlideContentReading:
    ...
    def test_get_slide_with_multiple_shapes(self, pptx_advanced_tools, temp_dir):
...
class TestWordReplaceGlobalVariablesComplex:
    ...
    def test_replace_in_tables(self, word_advanced_tools, temp_dir):
...
class TestPptxExtractContent:
    ...
    def test_extract_with_all_content_types(self, pptx_tools, temp_dir):
