...
class TestWordPromptFunctions:
    ...
    @pytest.mark.parametrize("method,args", [
        ("prompt_sow_data", []),
        ("prompt_sow_section", ["Test Section"]),
    ])
    def test_prompt_helpers(self, word_advanced_tools, method, args):
        """Test prompt helpers if available."""
        if hasattr(word_advanced_tools, method):
            result = getattr(word_advanced_tools, method)(*args)
...
class TestWordTrackChangesOperations:
    ...
    def test_enable_track_changes_output(self, word_advanced_tools, temp_dir):
    ...
    def test_patch_with_track_changes_complex(self, word_advanced_tools, temp_dir):
...
class TestWordTableCreation:
    ...
    def test_create_table_after_section(self, word_advanced_tools, temp_dir):
...
class TestPptxSlideOperations:
    ...
    def test_add_slide_with_layout_index(self, pptx_advanced_tools, temp_dir):
    ...
    def test_duplicate_slide_position_after(self, pptx_advanced_tools, temp_dir):
...
class TestPptxShapeOperations:
    ...
    def test_list_shapes_with_table(self, pptx_advanced_tools, temp_dir):
    ...
    def test_patch_shape_body(self, pptx_advanced_tools, temp_dir):
...
class TestPptxReplaceOperations:
    ...
    def test_replace_text_specific_slide(self, pptx_advanced_tools, temp_dir):
    ...
    def test_replace_placeholders_multiple(self, pptx_advanced_tools, temp_dir):
...
class TestPptxLayoutOperations:
    ...
    @pytest.mark.parametrize("layout_name", ["comparison", "blank"])
...
class TestWordComplexOperations:
    ...
    def test_generate_sow_with_data(self, word_advanced_tools, temp_dir):
...
class TestPptxCommentOperations:
    ...
    def test_add_comment_custom_author(self, pptx_advanced_tools, temp_dir):
...
class TestWordAuditOperations:
    ...
    def test_audit_completion_empty(self, word_advanced_tools, temp_dir):
...
class TestPptxSetTextAutofit:
    ...
    def test_set_autofit_shrink(self, pptx_advanced_tools, temp_dir):
    ...
    def test_set_autofit_none(self, pptx_advanced_tools, temp_dir):
