...
class TestPptxAddTableOperations:
    ...
    def test_add_table_with_many_rows(self, temp_dir):
    ...
    def test_add_table_single_column(self, temp_dir):
...
class TestWordInsertTableRowVariations:
    ...
    def test_insert_row_specific_position(self, temp_dir):
    ...
    def test_insert_row_empty_dict(self, temp_dir):
...
class TestPptxReplaceTextVariations:
    ...
    def test_replace_in_table_cells(self, temp_dir):
...
class TestWordCopyTemplateVariations:
    ...
    def test_copy_to_existing_location(self, temp_dir):
        ...
        result = tools.tool_word_copy_template(str(template), str(output))
        assert isinstance(result, dict)
...
class TestPptxClearBulletsVariations:
    ...
    def test_clear_bullets_no_body(self, temp_dir):
        ...
        result = tools.tool_pptx_clear_bullets(str(path), slide_number=1)
...
class TestWordListTablesVariations:
    ...
    def test_list_tables_multiple(self, temp_dir):
...
class TestPptxGetTableVariations:
    ...
    def test_get_table_multiple_tables(self, temp_dir):
        ...
        result = tools.tool_pptx_get_table(str(path), 1, table_index=1)
        assert isinstance(result, dict)
...
class TestWordPatchTableRowVariations:
    ...
    def test_patch_table_row_partial_columns(self, temp_dir):
        ...
        result = tools.tool_word_patch_table_row(
            str(path),
            "0",
            1,
...
class TestPptxAddCommentPositions:
    ...
    def test_add_comment_edge_position(self, temp_dir):
...
class TestWordSectionGuidanceVariations:
    ...
    def test_get_section_guidance_no_guidance(self, temp_dir):
        ...
        result = tools.tool_word_get_section_guidance(str(path), "Section")
        assert isinstance(result, dict)
...
class TestPptxNotesAppend:
    ...
    def test_append_to_existing_notes(self, temp_dir):
...
class TestWordCleanupSowVariations:
    ...
    def test_cleanup_sow_no_placeholders(self, temp_dir):
        ...
        result = tools.tool_word_cleanup_sow(str(path))
        assert isinstance(result, dict)
...
class TestPptxSlideReorderVariations:
    ...
    def test_reorder_reverse_all(self, temp_dir):
...
class TestWordCreateNewTableVariations:
    ...
    def test_create_table_before_section(self, temp_dir):
...
class TestExcelMultiSheetOperations:
    ...
    def test_from_markdown_multiple_tables(self, temp_dir):
...
"""
    ...
    def test_to_markdown_multi_sheet(self, temp_dir):
...
"""
        ...
        result = tools.tool_excel_to_markdown(str(path))
        # Should be a string
...
class TestPptxLayoutAnalysis:
    ...
    def test_analyze_layouts_standard_deck(self, temp_dir):
...
class TestWordPatchPlaceholderCases:
    ...
    def test_patch_placeholder_in_header(self, temp_dir):
